...
<body>
            ...
            <div>
                ...
                <ul class="p-0 m-0 list-none">
                    ...
                    <li data-tab="woocommerce"
                        class="tab-item font-figtree py-3 px-[15px] hover:bg-[#f5f5f5] cursor-pointer border-l-[3px] border-l-transparent transition-all duration-300 mb-[5px] rounded text-base">
                        WooCommerce
                    </li>
    ...
    <section class="max-w-[1240px] mx-auto">
        ...
        <div class="max-w-[900px] mx-auto mt-8">
            <button
                class="services-toggle w-full p-5 bg-transparent border border-[#13285e] text-[#13285e] rounded-md font-medium transition-all duration-300 cursor-pointer flex items-center justify-center gap-2">
                <span class="services-toggle-text">View More</span>

                <span class="">
                    <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 384 512"
                        class="w-4 h-4 fill-current transition-transform duration-300 rotate-180" aria-hidden="true"
                        focusable="false">
                        <path
                            d="M192 128c8.188 0 16.38 3.125 22.62 9.375l160 160c12.5 12.5 12.5 32.75 0 45.25s-32.75 12.5-45.25 0L192 205.2 54.63 342.6c-12.5 12.5-32.75 12.5-45.25 0s-12.5-32.75 0-45.25l160-160C175.6 131.1 183.8 128 192 128z">
                        </path>
                    </svg>
                </span>
            </button>
